...
export async function POST(req: NextRequest) {
  try {
    ...
    // Alle sjekede databaser med status
    const checkedDatabases = [
      {
        name: "Google Safe Browsing",
        found: googleHit,
        description: hasUrls ? "Googles database med millioner av kjente svindelnettsteder" : "Ingen lenker å sjekke",
      },
      {
        name: "destroy.tools",
        found: destroyResult.hit,
        description: hasUrls ? "Spesialisert database for phishing og svindeldomener" : "Ingen lenker å sjekke",
      },
      {
        name: "URLhaus (abuse.ch)",
        found: urlhausHit,
        description: hasUrls ? "Community-drevet database for skadelig programvare og botnett" : "Ingen lenker å sjekke",
      },
      {
        name: "VirusTotal",
        found: virusTotalResult.hit,
        description: hasUrls ? "70+ antivirusmotorer analyserer lenken" : "Ingen lenker å sjekke",
      },
      {
        name: "Nøkkelord-analyse",
        found: hasDangerKeyword || hasSuspiciousKeyword,
        description: "Sjekker etter typiske svindelord og -uttrykk på norsk",
      },
      {
        name: "URL-mønster",
        found: hasSuspiciousUrl,
        description: "Oppdager forkortede lenker og mistenkelige domeneendelser",
      },
    ];
